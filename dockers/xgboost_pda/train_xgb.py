...
def main(hparam_path: str, input_path: str, model_path: str, output_path: str):
    ...
    try:
        ...
        logger.info(f"Model path: {model_path}, Output path: {output_path}")
        ...
        logger.info(f"Checking output directory: {output_path}")
        if not os.path.exists(output_path):
            logger.warning(f"Output directory {output_path} does not exist, creating...")
