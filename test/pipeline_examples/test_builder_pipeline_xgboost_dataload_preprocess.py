...
from pipeline_examples.xgboost_atoz.builder_pipeline_xgboost_dataload_preprocess import XGBoostDataloadPreprocessPipelineBuilder
...
class TestXGBoostDataloadPreprocessPipelineBuilder(unittest.TestCase):
    def setUp(self):
        ...
        self.cradle_builder_patch = patch('pipeline_examples.xgboost_atoz.builder_pipeline_xgboost_dataload_preprocess.CradleDataLoadingStepBuilder')
        ...
        self.tp_builder_patch = patch('pipeline_examples.xgboost_atoz.builder_pipeline_xgboost_dataload_preprocess.TabularPreprocessingStepBuilder')
        ...
        # Mock Pipeline
        self.pipeline_patch = patch('pipeline_examples.xgboost_atoz.builder_pipeline_xgboost_dataload_preprocess.Pipeline')
        ...
        self.constants_patch = patch.multiple(
            'pipeline_examples.xgboost_atoz.builder_pipeline_xgboost_dataload_preprocess',
