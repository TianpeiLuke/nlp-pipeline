...
from ..pipeline_steps.config_training_step_pytorch import PyTorchTrainingConfig 
...
class PytorchEndToEndTemplate(PipelineTemplateBase):
    ...
    def __init__(
        ...
        """
        Initialize PyTorch End-to-End template.
        ...
        logger.info(f"Initialized PyTorch End-to-End template for: {self._get_pipeline_name()}")
    ...
    def _validate_configuration(self) -> None:
        ...
        for config_type, name in [
            (PytorchTrainingConfig, "PyTorch training"),
    ...
    def _create_step_builder_map(self) -> Dict[str, Type[StepBuilderBase]]:
        ...
        return {
            ...
            STEP_NAMES["PytorchTraining"]["spec_type"]: PyTorchTrainingStepBuilder,
    ...
    def _create_config_map(self) -> Dict[str, BasePipelineConfig]:
        ...
        for cfg_type, step_name in [
            (PytorchTrainingConfig, "pytorch_train"),
            ...
            # This prevents subclasses from matching when looking for parent class
    ...
    def _create_pipeline_dag(self) -> PipelineDAG:
        ...
        dag.add_node("pytorch_train")      # PyTorch training step
        ...
        dag.add_edge("train_preprocess", "pytorch_train")
        
        # Model artifact flow
        dag.add_edge("pytorch_train", "model_packaging")
        dag.add_edge("pytorch_train", "payload_test")
    ...
    def _get_pipeline_name(self) -> str:
        ...
        Returns:
            Pipeline name
        """
        return f"{self.base_config.pipeline_name}-pytorch-e2e"
...
def create_pipeline_from_template(
    ...
    """
    Create a PyTorch End-to-End pipeline using the template.
    ...
    Returns:
        SageMaker Pipeline
    """
    template = PytorchEndToEndTemplate(
        config_path=config_path,
        sagemaker_session=sagemaker_session,
        role=role,
        notebook_root=notebook_root
