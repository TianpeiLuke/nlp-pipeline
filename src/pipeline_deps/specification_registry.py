...
import logging
from .base_specifications import StepSpecification, DependencySpec, OutputSpec
...
class SpecificationRegistry:
    ...
    def register(self, step_name: str, specification: StepSpecification):
        ...
        logger.info(f"Registered specification for step '{step_name}' of type '{step_type}' in context '{self.context_name}'")
