"""
Batch Transform Testing Step Specification.

This module defines the declarative specification for batch transform testing steps,
...
# Batch Transform Testing Step Specification
BATCH_TRANSFORM_TESTING_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("BatchTransform", "testing"),
    ...
    dependencies=[
        ...
        DependencySpec(
            ...
            required=True,
            compatible_sources=["TabularPreprocessing-Testing"],
            semantic_keywords=["testing", "data", "features", "preprocessed", "tabular", "input_data", "model_input_data"],
            data_type="S3Uri",
            description="Processed testing data for batch transform from preprocessing step"
        )
    ],
    outputs=[
        OutputSpec(
