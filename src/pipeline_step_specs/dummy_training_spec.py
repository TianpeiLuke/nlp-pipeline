...
DummyTraining is designed to take a pretrained model and make it available for downstream
packaging and registration steps, bypassing the actual training process.
"""
